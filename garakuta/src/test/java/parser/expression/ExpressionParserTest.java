...
class ExpressionParserTest {
    ...
    static Stream<Fixture> fixtures() {
        return Stream.of(
                ...
                new Fixture("1+2+3+4", add(add(add(val(1), val(2)), val(3)), val(4)),
                        1 + 2 + 3 + 4),
                new Fixture("9-1-2-3", sub(sub(sub(val(9), val(1)), val(2)), val(3)),
                        9 - 1 - 2 - 3),
                new Fixture("1*2*3*4", mul(mul(mul(val(1), val(2)), val(3)), val(4)),
                        1 * 2 * 3 * 4),
                new Fixture("210/5/3/2", div(div(div(val(210), val(5)), val(3)), val(2)),
                        210 / 5 / 3 / 2),
