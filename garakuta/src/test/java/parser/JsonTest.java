...
public class JsonTest {
    ...
    public void test_number_0() throws Exception {
        final Map<String, Object> map = (Map<String, Object>) Json.get("{\"a\":0}");
        assertEquals(1, map.size());
    ...
    public void test_number_negative() throws Exception {
        final Map<String, Object> map = (Map<String, Object>) Json.get("{\"a\":-456}");
        assertEquals(1, map.size());
    ...
    public void test_number_point() throws Exception {
        final Map<String, Object> map = (Map<String, Object>) Json.get("{\"a\":12345.6789}");
        assertEquals(1, map.size());
    ...
    public void test_number_point_with_e() throws Exception {
        final Map<String, Object> map = (Map<String, Object>) Json.get("{\"a\":123e4}");
        assertEquals(1, map.size());
    ...
    public void test_number_point_with_e_with_sign() throws Exception {
        final Map<String, Object> map = (Map<String, Object>) Json.get("{\"a\":123e+4}");
        assertEquals(1, map.size());
    ...
    @Test
    public void test_number_point_with_E() throws Exception {
        final Map<String, Object> map = (Map<String, Object>) Json.get("{\"a\":567E-8}");
        assertEquals(1, map.size());
    ...
    public void test_number_full() throws Exception {
        final Map<String, Object> map = (Map<String, Object>) Json.get("{\"a\":-123.456e-7}");
        assertEquals(1, map.size());
    ...
    public void test_string_contains_double_quote() throws Exception {
        final Map<String, Object> map = (Map<String, Object>) Json.get("{\"a\":\"\\\"\"}");
        assertEquals(1, map.size());
    ...
    public void test_string_unicode() throws Exception {
        final Map<String, Object> map = (Map<String, Object>) Json.get("{\"a\":\"\\u3042\"}");
        assertEquals(1, map.size());
