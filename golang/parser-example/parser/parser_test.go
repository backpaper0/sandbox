...
func TestParse(t *testing.T) {
	...
	fixtures := []struct {
		...
		{"1 + 2 + 3", BinalyOperation{Add, BinalyOperation{Add, ScalarValue{Token{Integer, "1"}}, ScalarValue{Token{Integer, "2"}}}, ScalarValue{Token{Integer, "3"}}}},
		{"3 - 2 - 1", BinalyOperation{Sub, BinalyOperation{Sub, ScalarValue{Token{Integer, "3"}}, ScalarValue{Token{Integer, "2"}}}, ScalarValue{Token{Integer, "1"}}}},
		{"1 * 2 * 3", BinalyOperation{Mul, BinalyOperation{Mul, ScalarValue{Token{Integer, "1"}}, ScalarValue{Token{Integer, "2"}}}, ScalarValue{Token{Integer, "3"}}}},
		{"4 / 2 / 1", BinalyOperation{Div, BinalyOperation{Div, ScalarValue{Token{Integer, "4"}}, ScalarValue{Token{Integer, "2"}}}, ScalarValue{Token{Integer, "1"}}}},
