...
```bash
seq $(($(curl -s https://api.github.com/orgs/spring-projects | jq .public_repos) / 30)) | \
 while read page; do curl -o repos${page}.json -G -d page=${page} https://api.github.com/orgs/spring-projects/repos; done
```
